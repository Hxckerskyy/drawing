...
do
	Library = {
		Open = true;
		Accent = Color3.fromRGB(169, 21, 255);
		PageAmount = 0;
		Pages = {};
		Sections = {};
		Flags = {};
...
local Outline = Instance.new("Frame")
Outline.Name = "Outline"
Outline.AutomaticSize = Enum.AutomaticSize.X -- Only adjust width based on content
Outline.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
Outline.BorderColor3 = Color3.fromRGB(0, 0, 0)
Outline.Position = UDim2.new(0.01, 0, 0.02, 0)
Outline.Size = UDim2.new(0, 0, 0, 16) -- Fixed height (16), but width adjusts based on text length
Outline.Visible = true -- Set visible to true to see changes
...
Inline.BorderSizePixel = 0
Inline.Position = UDim2.new(0, 1, 0, 1)
Inline.Size = UDim2.new(1, -2, 1, -2) -- Padding inside the container for the text

local Value = Instance.new("TextLabel")
Value.Name = "Value"
Value.FontFace = Font.new(Font:GetRegistry("UI_FONT"))
Value.Text = "Watermark Text" -- The watermark text
Value.TextColor3 = Color3.fromRGB(255, 255, 255)
Value.TextSize = 12
Value.TextStrokeTransparency = 0
Value.TextXAlignment = Enum.TextXAlignment.Left
...
Value.BorderColor3 = Color3.fromRGB(0, 0, 0)
Value.BorderSizePixel = 0
Value.Size = UDim2.new(0, 0, 1, 0) -- Set width to auto adjust, but keep the height fixed

local UIPadding = Instance.new("UIPadding")
UIPadding.Name = "UIPadding"
UIPadding.PaddingLeft = UDim.new(0, 5) -- Add some padding on the left side of the text
UIPadding.PaddingRight = UDim.new(0, 5) -- Add padding on the right side
UIPadding.Parent = Value
